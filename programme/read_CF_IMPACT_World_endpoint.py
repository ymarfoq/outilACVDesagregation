def read_CF_IMPACT_World_endpoint(reader, unit_converter, CF_categories, CF_units):
    ...
    CF_categories['IMPACT World mid_end'] = []
    CF_categories['IMPACT World endpoint'] = []
    CF_units['IMPACT World mid_end'] = []
    CF_units['IMPACT World endpoint'] = []
    ...
    impact_method = 'IMPACT World mid_end'
    ...
    impact_method = 'IMPACT World endpoint'
    line = next(reader)
    endpoint_category = line[0]
    unit = line[1]
    CF_categories[impact_method].append(endpoint_category)
    CF_units[impact_method].append(unit)
